...
namespace PoolKit
{
	...
	public class HumanPlayer : BasePlayer 
	{
		...
		void Update()
		{
			if(m_myTurn==false || m_gameOver || WhiteBall.CueBallSiding)
			{
				return;
			}
        ...
        public static void CueRotate(float angle)
        {
            if (m_Instance != null)
                m_Instance._CueRotate(angle);
        }

        private void _CueRotate(float angle)
        {
