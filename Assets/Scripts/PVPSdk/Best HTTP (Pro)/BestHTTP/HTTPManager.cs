...
namespace BestHTTP
{
    ...
    public static class HTTPManager
    {
        ...
        internal static Dictionary<string, string> hostDict = new Dictionary<string, string>();
...
//        private static Dictionary<string, List<HTTPConnection>> Connections = new Dictionary<string, List<HTTPConnection>>();
        ...
        internal static System.Object hostCacheLock = new System.Object();

        public static void AddHostCache(string host, string address) {
            lock (hostCacheLock) {
                hostDict [host] = address;
            }
        }

        public static string GetHostCache(string host) {
            lock (hostCacheLock) {
                return hostDict.ContainsKey (host) ? hostDict [host] : null;
            }
        }
        ...
        private static HTTPConnection FindOrCreateFreeConnection(Uri uri)
        {
            ...
            conn = new HTTPConnection(serverUrl);
